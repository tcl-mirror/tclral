...
*/
static const char rcsid[] = "@(#) $RCSfile: ral_relationheading.c,v $ $Revision: 1.24.2.1 $" ;
    ...
    Ral_AttributeTypeScanFlags *flags)
{
     ...
     */
    length += Ral_TupleHeadingScan(h->tupleHeading, flags) ;
    /*
    ...
    Ral_AttributeTypeScanFlags *flags)
{
     ...
     */
    strcpy(p, ral_relationKeyword) ;
    p += strlen(ral_relationKeyword) ;
    /*
     * Add the heading.
     */
    *p++ = ' ' ;
    p += Ral_TupleHeadingConvert(tupleHeading, p, flags) ;
    /*
     * Add the identifiers.
     */
    *p++ = ' ' ;
